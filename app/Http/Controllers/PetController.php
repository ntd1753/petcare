...
//            $medication->patient_id = $patient_id; // Gán khóa ngoại của bệnh nhân
    ...
    function addform(): \Illuminate\Contracts\View\Factory|\Illuminate\Foundation\Application|\Illuminate\Contracts\View\View|\Illuminate\Contracts\Foundation\Application
    {
        //$author=Auth::user();
//        $pets=Pet::where('ownerID','=', Auth::user()->id)->with('species')->get();

        return view('content.doctor.CRUD_patient.addPatient.patient_add');
    }
    public function store(Request $request): \Illuminate\Http\RedirectResponse
    {
        ...
        $patient = new Patient();
        $patient->petId = $validatedData['pet_id']; // Liên kết với pet_id
