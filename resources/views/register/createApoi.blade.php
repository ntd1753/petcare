                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li class="active">
                        ...
                        <ul id="doctor-info" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                           ...
                           <li class="active"><a href="add-doctor.html"><i class="ri-user-add-fill"></i> Add Doctor</a></li>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-9">
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">New Pet Information</h4>
                           </div>
                        </div>
                        <div class="iq-card-body">
                           <div class="new-user-info">
                              <form class="mt-4" method="POST" action="registerApoi">
                                 @csrf
                                 <div class="row">
